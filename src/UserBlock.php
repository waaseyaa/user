...
{
    #[Field(type: 'integer', label: 'Blocker ID', settings: ['weight' => 0, 'authorizationInput' => true], read: \Waaseyaa\Entity\FieldReadLevel::Protected)]
    public int $blocker_id = 0;

    #[Field(type: 'integer', label: 'Blocked ID', settings: ['weight' => 1], read: \Waaseyaa\Entity\FieldReadLevel::Protected)]
